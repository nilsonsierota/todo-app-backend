...
describe('TodoController', () => {
  ...
  describe('findOneOrFail', () => {
    it('should get a todo item successfully', async () => {
      // Act
      const result = await todoController.findOneOrFail('1');
    ...
    it('should throw an exception', () => {
      ...
      // Assert
      expect(todoController.findOneOrFail('1')).rejects.toThrowError();
    });
  });
  ...
  describe('updateById', () => {
    it('should update a todo item successfully', async () => {
      ...
      // Act
      const result = await todoController.save('1', body);
    ...
    it('should throw an exception', () => {
      ...
      // Assert
      expect(todoController.save('1', body)).rejects.toThrowError();
    });
  });
  ...
  describe('deleteById', () => {
    it('should remove a todo item successfully', async () => {
      // Act
      const result = await todoController.deleteById('1');
    ...
    it('should throw an exception', () => {
      ...
      // Assert
      expect(todoController.deleteById('1')).rejects.toThrowError();
    });
  });
});
